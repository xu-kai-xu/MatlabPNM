function [oil_rel_perm,Water_rel_perm] = k_rel_imb(p_in,p_out,NodeL,cluster_A_nums)

global pore_data throat_data nz ny nx n_t
global q_tot inletLayer
...
for i = 1:n_t
    if pore_data((throat_data(i,21)),3) == inletLayer && pore_data((throat_data(i,22)),3) == inletLayer + 1 || ...
        ...
        if any(NodeL(throat_data(i,21)) == cluster_A_nums(:))...
                && any(NodeL(throat_data(i,22)) == cluster_A_nums(:))
